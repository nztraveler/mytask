/**
 * Created by likui on 2016/1/18.
 * 常量配置
 */
// 'use strict';
angular.module('myApp')
//订单类型
    .constant('indentStatus', [
        {status: 1, name: '待发货'},
        {status: 2, name: '待付款'},
        {status: 3, name: '交易完成'},
        {status: 4, name: '待收货'}
    ...
    //职业
    .constant('POSITION', {
        '1': {id: 1, position: 'css', name: 'css工程师', json: 'cssJson.json'},
        '2': {id: 2, position: 'js', name: 'js工程师', json: 'jsJson.json'},
        '3': {id: 3, position: 'android', name: 'android工程师', json: 'androidJson.json'},
        '4': {id: 4, position: 'ios', name: 'ios工程师', json: 'iosJson.json'},
        '5': {id: 5, position: 'java', name: 'java工程师', json: 'javaJson.json'},
        '6': {id: 6, position: 'op', name: '运维工程师', json: 'opJson.json'},
        '7': {id: 7, position: 'pm', name: '产品经理', json: 'pmJson.json'},
        '8': {id: 8, position: 'ui', name: 'UI设计师', json: 'uiJson.json'}
    })
    //服务类别
    .constant('cloudType', {
        type: {
